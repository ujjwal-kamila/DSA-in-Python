...
class Node:
    def __init__(self, item=None, next=None):
        self.item = item  # Holds the data (value) 
        self.next = next  # Holds the reference

# Singly Linked List class 
class SLL:
    def __init__(self, start=None):
        self.start = start  # Points to the head

    # Check if the linked list is empty
    def is_empty(self):
        return self.start is None  # Returns True if empty
